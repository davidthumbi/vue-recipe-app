  ...
  <div class="max-w-[800px] mx-auto p-8">
    ...
    <div class="grid grid-cols-2">
      <div>
        ...
        <ul>
          <template v-for="ind in maxIngredients" :key="ind">
...
// Compute the indexes of available ingredients and measures
const maxIngredients = computed(() =>
  Array.from({ length: 20 }, (_, i) => i + 1).filter(i => meal.value[`strIngredient${i}`])
);
</script>
